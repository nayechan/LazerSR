...
namespace osu.Game.Rulesets.Mania.Difficulty.Utils
{
    public static class DifficultyValueUtils
    {
        ...
        /// Ported from osu!'s own DifficultyCalculationUtils/DiffUtils (osu.Game.Rulesets.Difficulty.Utils)
        /// instead of referencing it directly, since that class has been renamed across osu! releases.
        /// </summary>
        ...
        /// <summary>
        /// S-shaped logistic function (https://en.wikipedia.org/wiki/Logistic_function).
        /// Ported from osu!'s own DifficultyCalculationUtils/DiffUtils for the same reason as <see cref="Smoothstep"/>.
        /// </summary>
