...
namespace osu.Game.Rulesets.Mania.Difficulty.Preprocessing
{
    ...
    public class ManiaDifficultyPreprocessor
    {
        ...
        /// </summary>
        public static void ProcessAndAssign(List<ManiaDifficultyHitObject> hitObjects, IBeatmap beatmap)
        {
            ...
            hitObjects.ForEach(hitObject => hitObject.DifficultyData = data);
        }

        /// <summary>
        /// Categorizes hit objects into specialized <see cref="ManiaDifficultyHitObject"/> lists and performs initial setup.
        /// </summary>
        private static void createDifficultyHitObjectLists(ManiaDifficultyData data, List<ManiaDifficultyHitObject> hitObjects)
        {
        ...
        private static void setStrainPointIndices(double[] strainTimePoints, List<ManiaDifficultyHitObject> hitObjects)
        {
            ...
            foreach (var obj in hitObjects)
            {
                ...
                obj.StrainTimePointIndex = strainPointIndex;
            }
        }
        ...
        private static double calculateHitLeniency(IBeatmap beatmap)
        {
            ...
            rawLeniency = Math.Min(rawLeniency, SunnyConstants.HitLeniencyKneeSlope * (rawLeniency - SunnyConstants.HitLeniencyKneePoint) + SunnyConstants.HitLeniencyKneePoint);
