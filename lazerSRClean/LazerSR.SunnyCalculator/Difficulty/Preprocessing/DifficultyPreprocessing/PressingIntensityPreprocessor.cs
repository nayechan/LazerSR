...
namespace osu.Game.Rulesets.Mania.Difficulty.Preprocessing.DifficultyPreprocessing
{
    public static class PressingIntensityPreprocessor
    {
        ...
        // stream_boost_min_ratio / stream_boost_max_ratio -> SunnyConstants
        ...
        private static double[] computeAnchorFromKeyUsage(double[][] keyUsage400)
        {
            ...
            for (int timeIndex = 0; timeIndex < timePoints; timeIndex++)
            {
                ...
                double adjustedValue = anchorValue - SunnyConstants.AnchorCubicOffset;
                double cubicTerm = adjustedValue * adjustedValue * adjustedValue;
                anchorValues[timeIndex] = 1.0 + Math.Min(anchorValue - SunnyConstants.AnchorLinearOffset, SunnyConstants.AnchorCubicMultiplier * cubicTerm);
            }
        ...
        private static void processSimultaneousNotes(ManiaDifficultyHitObject currentNote, ManiaDifficultyData data, double[] pressingIntensityBase, int timePoints)
        {
            ...
            double chordDifficulty = SunnyConstants.ChordScale * Math.Pow(0.02 * (4.0 / data.HitLeniency - 24.0), 0.25);
        ...
        private static double calculateLongNoteBoost(ManiaDifficultyHitObject currentNote, ManiaDifficultyHitObject nextNote, LongNoteDensityData longNoteDensity)
        {
            ...
            return 1.0 + SunnyConstants.LongNoteBoost * 0.001 * longNoteDensitySum;
        }
        ...
        private static double calculateStreamBoost(double deltaTime)
        {
            ...
            if (streamRatio > SunnyConstants.StreamBoostMinRatio && streamRatio < SunnyConstants.StreamBoostMaxRatio)
            {
                double ratioDistance = streamRatio - SunnyConstants.StreamBoostMaxRatio;
                double quadraticFactor = ratioDistance * ratioDistance;

                return 1.0 + stream_boost_coefficient * (streamRatio - SunnyConstants.StreamBoostMinRatio) * quadraticFactor;
            }
