...
namespace osu.Game.Rulesets.Mania.Difficulty.Preprocessing.DifficultyPreprocessing
{
    public static class CrossColumnPreprocessor
    {
        ...
        {
            List<ManiaDifficultyHitObject>[] columns = data.AllNotes.First().PerColumnObjects;
        ...
        private static double calculateFastPressure(double deltaTimeSeconds, double hitLeniency)
        {
            ...
            double fastPressureRaw = SunnyConstants.FastPressureCoefficient * (1.0 / (minDelta * minDelta)) - SunnyConstants.FastPressureOffset;
        ...
        private static double[] getCrossHandCoefficients(int keyCount)
        {
            ...
            double[][] crossMatrix =
            {
                ...
                new[] { SunnyConstants.CrossOuter, SunnyConstants.CrossInner, SunnyConstants.CrossCentre, SunnyConstants.CrossInner, SunnyConstants.CrossOuter }, // 4K
