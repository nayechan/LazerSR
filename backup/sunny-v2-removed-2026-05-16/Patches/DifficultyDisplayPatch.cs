...
// Strategy B (Sibling-Clone): patch BeatmapTitleWedge.LoadComplete and add a SunnyDifficultyDisplay
// instance as a new sibling of the original DifficultyDisplay inside the wedge's outer FillFlowContainer.
...
public static class DifficultyDisplayPatch
{
    ...
    // InternalChildren on CompositeDrawable is protected, so reflect once at class init.
