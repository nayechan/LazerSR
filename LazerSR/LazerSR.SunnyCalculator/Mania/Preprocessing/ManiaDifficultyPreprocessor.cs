...
using LazerSR.Sunny.Mania.Preprocessing.Data;
using LazerSR.Sunny.Mania.Preprocessing.DifficultyPreprocessing;
using LazerSR.Sunny.Mania.Preprocessing.UtilityPreprocessing;

namespace LazerSR.Sunny.Mania.Preprocessing
{
    /// <summary>
    ...
    public class ManiaDifficultyPreprocessor
    {
        ...
        public static void ProcessAndAssign(List<DifficultyHitObject> hitObjects, IBeatmap beatmap) =>
            ProcessAndAssign(hitObjects, beatmap, CancellationToken.None);

        public static void ProcessAndAssign(List<DifficultyHitObject> hitObjects, IBeatmap beatmap, CancellationToken cancellationToken)
        {
